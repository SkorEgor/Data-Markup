...
"} ")
        ...
        self.pushButton_reading_file_without_gas = QtWidgets.QPushButton(self.groupBox_no_gas)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_reading_file_without_gas.sizePolicy().hasHeightForWidth())
        self.pushButton_reading_file_without_gas.setSizePolicy(sizePolicy)
        self.pushButton_reading_file_without_gas.setMinimumSize(QtCore.QSize(30, 30))
        self.pushButton_reading_file_without_gas.setMaximumSize(QtCore.QSize(16777215, 30))
        self.pushButton_reading_file_without_gas.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_reading_file_without_gas.setWhatsThis("")
        self.pushButton_reading_file_without_gas.setAccessibleName("")
        self.pushButton_reading_file_without_gas.setAccessibleDescription("")
        self.pushButton_reading_file_without_gas.setStyleSheet("QPushButton:hover {\n"
"    border: none;                                                /* без границ */\n"
"}")
        self.pushButton_reading_file_without_gas.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/shared/resource/file_download_white_24dp.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_reading_file_without_gas.setIcon(icon1)
        self.pushButton_reading_file_without_gas.setIconSize(QtCore.QSize(25, 25))
        self.pushButton_reading_file_without_gas.setObjectName("pushButton_reading_file_without_gas")
        self.layout_no_gas.addWidget(self.pushButton_reading_file_without_gas)
...
"}")
        ...
        self.widget_window_width = QtWidgets.QWidget(self.scrollAreaWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widget_window_width.sizePolicy().hasHeightForWidth())
        self.widget_window_width.setSizePolicy(sizePolicy)
        self.widget_window_width.setMinimumSize(QtCore.QSize(0, 30))
        self.widget_window_width.setStyleSheet("")
        self.widget_window_width.setObjectName("widget_window_width")
        self.layout_end_range = QtWidgets.QHBoxLayout(self.widget_window_width)
        ...
        self.label_text_window_width_2 = QtWidgets.QLabel(self.widget_window_width)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_text_window_width_2.sizePolicy().hasHeightForWidth())
        self.label_text_window_width_2.setSizePolicy(sizePolicy)
        self.label_text_window_width_2.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.label_text_window_width_2.setFont(font)
        self.label_text_window_width_2.setStyleSheet("")
        self.label_text_window_width_2.setObjectName("label_text_window_width_2")
        self.layout_end_range.addWidget(self.label_text_window_width_2)
        self.lineEdit_window_width_2 = QtWidgets.QLineEdit(self.widget_window_width)
        self.lineEdit_window_width_2.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_window_width_2.sizePolicy().hasHeightForWidth())
        self.lineEdit_window_width_2.setSizePolicy(sizePolicy)
        self.lineEdit_window_width_2.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_window_width_2.setMaximumSize(QtCore.QSize(1000, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.lineEdit_window_width_2.setFont(font)
        self.lineEdit_window_width_2.setStyleSheet("")
        self.lineEdit_window_width_2.setText("20")
        self.lineEdit_window_width_2.setMaxLength(10)
        self.lineEdit_window_width_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_window_width_2.setDragEnabled(False)
        self.lineEdit_window_width_2.setReadOnly(False)
        self.lineEdit_window_width_2.setObjectName("lineEdit_window_width_2")
        self.layout_end_range.addWidget(self.lineEdit_window_width_2)
        self.label_text_units_window_width_2 = QtWidgets.QLabel(self.widget_window_width)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_text_units_window_width_2.sizePolicy().hasHeightForWidth())
        self.label_text_units_window_width_2.setSizePolicy(sizePolicy)
        self.label_text_units_window_width_2.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.label_text_units_window_width_2.setFont(font)
        self.label_text_units_window_width_2.setStyleSheet("")
        self.label_text_units_window_width_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_text_units_window_width_2.setObjectName("label_text_units_window_width_2")
        self.layout_end_range.addWidget(self.label_text_units_window_width_2)
        self.Layout_scroll_menu.addWidget(self.widget_window_width)
...
"")
        ...
        self.groupBox_frequency_range = QtWidgets.QGroupBox(self.scrollAreaWidgetContents)
...
"}")
        ...
        self.Layout_scroll_menu.addWidget(self.groupBox_frequency_range)
...
"} ")
        ...
        self.radioButton_selected_range.toggled['bool'].connect(self.lineEdit_window_width_2.setEnabled) # type: ignore
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_text_window_width_2.setText(_translate("Dialog", " Ширина окна "))
        self.label_text_units_window_width_2.setText(_translate("Dialog", " [Шт]"))
